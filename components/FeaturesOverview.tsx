...
import { featuresOverview } from "@/constants";
      ...
      <div className="px-4 sm:px-6 mx-auto" style={{ maxWidth: "1280px" }}>
        <div className="md:max-w-3/4 mx-auto">
          <h1 className="text-center">
            Innovate, Secure, Succeed Smart Solutions for Your Business
          </h1>
        ...
        <div className="mt-12 relative">
            ...
            <div ref={sliderRef} className="keen-slider">
              {featuresOverview.map((feature, idx) => (
                <div key={idx} className="keen-slider__slide px-0 md:px-2 py-2">
                  <div className="w-full h-full md:pr-2">
                    <FeatureCard
                      title={feature.title}
          ...
          {loaded && instanceRef.current && (
            <div className="flex justify-center gap-2 mt-6">
              {[...Array(featuresOverview.length)].map((_, idx) => (
                <button
                  key={idx}
